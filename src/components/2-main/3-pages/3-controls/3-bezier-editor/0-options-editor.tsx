// Source: https://github.com/motiondivision/motion-vscode/blob/main/src/plus/components/OptionsEditor.tsx
import { BezierDefinition } from "motion";
import { useEffect, useState } from "react";
import { AnimationPreview } from "./1-animation-preview";
import { BezierCurveEditor } from "./2-bezier-curve-editor/1-bezier-curve-editor";
        ...
        <div className="curve-container" id="curve-container">
            ...
            <BezierCurveEditor
                ...
                onChange={(newCurve) => {
                    ...
                    //vscode.postMessage({type: "updateBezier", value: newCurve.join(", "), })
                }}
            />
            <AnimationPreview
                duration={500}
