// Source: https://github.com/motiondivision/motion-vscode/blob/main/src/plus/components/AnimationPreview.tsx
...
export function AnimationPreview({ duration, easing }: AnimationPreviewProps) {
    ...
    return (
        <section ref={container} className="preview" onClick={() => playAnimation()}>
