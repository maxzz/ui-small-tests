...
const MotionExampleComponents: Record<MotionExampleId, React.ComponentType> = {
    ...
    // Tests
    "test-drag-propagation": MotionExamples.TestDragPropagationDemo,
    "test-svg-layout-animation-correction": MotionExamples.TestSvgLayoutAnimationCorrectionDemo,
    "test-layout-transform": MotionExamples.TestLayoutTransformDemo,
    "test-layout-drag-transform": MotionExamples.TestLayoutDragTransformDemo,
    "test-drag-set-state": MotionExamples.TestDragSetStateDemo,
    "test-drag-overdrag": MotionExamples.TestDragOverdragDemo,
    "test-drag-external-control": MotionExamples.TestDragExternalControlDemo,
    "test-drag-device": MotionExamples.TestDragDeviceDemo,
    "test-drag-containing-input": MotionExamples.TestDragContainingInputDemo,
    "test-drag-constraints-ref-smaller-than-child": MotionExamples.TestDragConstraintsRefSmallerThanChildDemo,
    "test-drag-constraints-ref-scale": MotionExamples.TestDragConstraintsRefScaleDemo,
    "test-drag-constraints-ref": MotionExamples.TestDragConstraintsRefDemo,
    "test-drag-constraints": MotionExamples.TestDragConstraintsDemo,
    "test-drag-constraint-changes": MotionExamples.TestDragConstraintChangesDemo,
    "test-drag-clickable": MotionExamples.TestDragClickableDemo,
    "test-conditional-draggable": MotionExamples.TestConditionalDraggableDemo,
    "test-animate-stress-external-motion-value": MotionExamples.TestAnimateStressExternalMotionValueDemo,
    "test-animate-stress-empty-transforms": MotionExamples.TestAnimateStressEmptyTransformsDemo,
