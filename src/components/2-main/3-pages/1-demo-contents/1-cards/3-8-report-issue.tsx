        ...
        <Card>
            ...
            <CardContent className="flex flex-col gap-6">
                <div className="grid gap-4 @2xl:grid-cols-2">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <Select defaultValue="2">
                            <SelectTrigger id={`security-level-${id}`} className="w-full [&_span]:block! [&_span]:truncate" aria-label="Security Level">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <Textarea id={`description-${id}`} className="min-h-28" placeholder="Please include all information relevant to your issue." />
                </div>
            </CardContent>
