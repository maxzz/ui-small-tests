                ...
                <TooltipProvider delayDuration={0}>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button size="icon" variant="secondary" className="ml-auto size-8 rounded-full" onClick={() => setOpen(true)}>
                                <PlusIcon />
        ...
        <ResponsiveDialog open={open} onOpenChange={setOpen}>
            <ResponsiveDialogContent className="flex max-h-[85%] flex-col gap-0">
                ...
                <ResponsiveDialogHeader className="p-4 pt-0 sm:pt-5">
                    ...
                    <ResponsiveDialogDescription>Invite a user to this thread. This will create a new group message.</ResponsiveDialogDescription>
                ...
                <ResponsiveDialogFooter className="items-center border-t p-4 sm:justify-between">
                    ...
                    <Button onClick={() => { setOpen(false); }} disabled={selectedUsers.length < 2}>
                        Continue
                    </Button>
