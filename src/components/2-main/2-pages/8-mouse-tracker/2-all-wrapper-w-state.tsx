...
const hoverStackAtom = atom<HoverStackEntry[]>([]);
const mousePosAtom = atom<{ x: number; y: number; } | null>(null);

function MouseMoveTracker({ className, children, ...rest }: HTMLAttributes<HTMLDivElement>) {
