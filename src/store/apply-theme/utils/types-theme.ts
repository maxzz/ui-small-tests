...
export const themeStylePropsSchema = z.object({
    ...
    "chart-4":                            /**/ z.string(),
    "chart-5":                            /**/ z.string(),
    "sidebar":                            /**/ z.string().describe("The background color for the sidebar, paired with `sidebar-foreground`."),
    "sidebar-foreground":                 /**/ z.string().describe("Paired with `sidebar`."),
    "sidebar-primary":                    /**/ z.string().describe("The primary color for sidebar elements, paired with `sidebar-primary-foreground`."),
    "sidebar-primary-foreground":         /**/ z.string().describe("Paired with `sidebar-primary`."),
    "sidebar-accent":                     /**/ z.string().describe("An accent color for the sidebar, paired with `sidebar-accent-foreground`."),
    ...
    "font-sans":                          /**/ z.string().describe("Primary UI font. May be serif, sans, monospace, or display depending on the theme vibe."),
